...
def evaluate(opt):
        ...
        with torch.no_grad():
            ...
            for data in dataloader:
                ...
                for i in range(1):
                    ...
                    # a1 = output["re-diffusion"][0].cpu().numpy().squeeze()
                    # a2 = output["re-diffusion"][1].cpu().numpy().squeeze()
                    # a3 = output["re-diffusion"][2].cpu().numpy().squeeze()

                    # b1 = output["re-diffusion_1"][0].cpu().numpy().squeeze()
                    # b2 = output["re-diffusion_1"][1].cpu().numpy().squeeze()
                    # b3 = output["re-diffusion_1"][2].cpu().numpy().squeeze()
                    # b4 = output["re-diffusion_1"][3].cpu().numpy().squeeze()

                    # c1 = output["re-diffusion_2"][0].cpu().numpy().squeeze()
                    # c2 = output["re-diffusion_2"][1].cpu().numpy().squeeze()
                    # c3 = output["re-diffusion_2"][2].cpu().numpy().squeeze()
                    # c4 = output["re-diffusion_2"][3].cpu().numpy().squeeze()
                    # c5 = output["re-diffusion_2"][4].cpu().numpy().squeeze()

                    # name1 = os.path.join('/data4/shaoshuwei/workdir/Lite-Mono-main/sub_depth/', "{}_a1.png".format(index))
                    # name2 = os.path.join('/data4/shaoshuwei/workdir/Lite-Mono-main/sub_depth/', "{}_a2.png".format(index))
                    # name3 = os.path.join('/data4/shaoshuwei/workdir/Lite-Mono-main/sub_depth/', "{}_a3.png".format(index))

                    # name4 = os.path.join('/data4/shaoshuwei/workdir/Lite-Mono-main/sub_depth/', "{}_b1.png".format(index))
                    # name5 = os.path.join('/data4/shaoshuwei/workdir/Lite-Mono-main/sub_depth/', "{}_b2.png".format(index))
                    # name6 = os.path.join('/data4/shaoshuwei/workdir/Lite-Mono-main/sub_depth/', "{}_b3.png".format(index))
                    # name7 = os.path.join('/data4/shaoshuwei/workdir/Lite-Mono-main/sub_depth/', "{}_b4.png".format(index))

                    # name8 = os.path.join('/data4/shaoshuwei/workdir/Lite-Mono-main/sub_depth/', "{}_c1.png".format(index))
                    # name9 = os.path.join('/data4/shaoshuwei/workdir/Lite-Mono-main/sub_depth/', "{}_c2.png".format(index))
                    # name10 = os.path.join('/data4/shaoshuwei/workdir/Lite-Mono-main/sub_depth/', "{}_c3.png".format(index))
                    # name11 = os.path.join('/data4/shaoshuwei/workdir/Lite-Mono-main/sub_depth/', "{}_c4.png".format(index))
                    # name12 = os.path.join('/data4/shaoshuwei/workdir/Lite-Mono-main/sub_depth/', "{}_c5.png".format(index))

                    # plt.imsave(name1, a1, cmap='magma')
                    # plt.imsave(name2, a2, cmap='magma')
                    # plt.imsave(name3, a3, cmap='magma')
                    # plt.imsave(name4, b1, cmap='magma')
                    # plt.imsave(name5, b2, cmap='magma')
                    # plt.imsave(name6, b3, cmap='magma')
                    # plt.imsave(name7, b4, cmap='magma')
                    # plt.imsave(name8, c1, cmap='magma')
                    # plt.imsave(name9, c2, cmap='magma')
                    # plt.imsave(name10, c3, cmap='magma')
                    # plt.imsave(name11, c4, cmap='magma')
                    # plt.imsave(name12, c5, cmap='magma')
    ...
    for i in range(pred_disps.shape[0]):
        ...
        # save_vis = False
        save_vis = False
        save_dir = "/data4/shaoshuwei/workdir/Lite-Mono-main/pred_depth"
        # save_dir = "/data2/sundingchi/code/monodepth2-master/pred_depth_test"
        if save_vis:
        # rgb =.permute(1, 2, 0)
